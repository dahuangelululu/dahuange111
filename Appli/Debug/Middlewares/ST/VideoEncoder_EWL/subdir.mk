...
C_SRCS += \
../Middlewares/ST/VideoEncoder_EWL/ewl_impl.c 

OBJS += \
./Middlewares/ST/VideoEncoder_EWL/ewl_impl.o 

C_DEPS += \
./Middlewares/ST/VideoEncoder_EWL/ewl_impl.d 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/ST/VideoEncoder_EWL/%.o Middlewares/ST/VideoEncoder_EWL/%.su Middlewares/ST/VideoEncoder_EWL/%.cyclo: ../Middlewares/ST/VideoEncoder_EWL/%.c Middlewares/ST/VideoEncoder_EWL/subdir.mk
...
clean: clean-Middlewares-2f-ST-2f-VideoEncoder_EWL

clean-Middlewares-2f-ST-2f-VideoEncoder_EWL:
	-$(RM) ./Middlewares/ST/VideoEncoder_EWL/ewl_impl.cyclo ./Middlewares/ST/VideoEncoder_EWL/ewl_impl.d ./Middlewares/ST/VideoEncoder_EWL/ewl_impl.o ./Middlewares/ST/VideoEncoder_EWL/ewl_impl.su

.PHONY: clean-Middlewares-2f-ST-2f-VideoEncoder_EWL
